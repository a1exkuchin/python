...
#двух клеток. В классе необходимо реализовать метод make_order(), принимающий 
...
#аргументу. Если ячеек на формирование ряда не хватает, то в последний ряд 
...
class Cell:
    ...
    def __sub__(self, other):
        if (self.num - other.num) > 0:
            ...
            return f'Операцию выполнить невозможно!'
