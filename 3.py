...
#и премия, например, {"wage": wage, "bonus": bonus}. Создать класс Position 
...
person = Position('Василий', 'Пупкин', 'программист', 150000, 50000)
print('ФИО: ', person.get_full_name())
print('Должность: ', person.position)
print('Заработная плата: ', person.get_total_income(), 'ден. ед.')
